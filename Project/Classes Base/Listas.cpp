...
void listaEmpregados () {
    ...
    empregado emp1("Manuel Cardoso", 1);
    emp1.setPWD("Manel123_");

    empregado emp2("Pedro Mota", 2);
    emp2.setPWD("PedroTukTuk");

    empregado emp3("António Coutinho", 3);
...
void listaProdutos () {
    ...
    produto gow1 ("PS2", "God of War", 1);
    produto er ("PS5", "Elden Ring", 2);
    produto re9 ("PC", "Resident Evil: REQUIEM", 3);
...
void listaClientes () {
    ...
    cliente cl1("Mário Cotrim", "mariocotrim@gmail.com", 202748464);

    cliente cl2("Ricardo Campos", "richie22camp@gmail.com", 261997367);

    cliente cl3("Samuel Mira", "samthekid@gmail.com", 195678090);
